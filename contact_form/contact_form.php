...
// configure
$from = 'Contato Site Trabalho <yourmail@domain.com>';
$sendTo = 'herman.moura@gmail.com';
$subject = 'Contato Site Trabalho';
$fields = array('name' => 'Name', 'email' => 'Email', 'message' => 'Message'); // array variable name => Text to appear in the email
$okMessage = 'Mensagem enviada. Logo entrarei em contato. Tá com pressa? Manda uma mensagem para o meu Whatsapp, eu respondo mais rápido.';
$errorMessage = 'Houve um erro no envio do formulário. Manda uma mensagem para o meu Whatsapp.';
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $errorMessage = 'Clica aí e faz o reCAPTCHA.';
    $responseArray = array('type' => 'danger', 'message' => $errorMessage);
    $encoded = json_encode($responseArray);
